                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-6">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                <InputLabel for="event_max_capacity" value="Max Capacity" />
                                <TextInput id="event_max_capacity" type="number" v-model="form.event_max_capacity"
                                    class="mt-1 block w-full" required />
                            </div>

                            <div class="mb-4">
                                <InputLabel>
                                    <input type="checkbox" v-model="form.event_status" />
                                    Active Event
                                </InputLabel>
                            </div>
